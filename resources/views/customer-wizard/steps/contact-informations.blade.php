				...
				<div>
					...
					<div class="mt-4 grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-6">
						<div class="sm:col-span-3">
							<x-jet-input :disabled="!auth()->user()->can('customer_update')" wire:model.defer="pec" type="email" for="pec" label="PEC"></x-jet-input>
						</div>
						<div class="sm:col-span-3">
							<x-jet-input :disabled="!auth()->user()->can('customer_update')" wire:model.defer="notification_email" type="email" for="notification_email"
							             label="Email notifiche"></x-jet-input>
						</div>
						<div class="sm:col-span-3">
							<x-jet-input :disabled="!auth()->user()->can('customer_update')" wire:model.defer="vat_number" type="text" for="vat_number"
							             label="Partita IVA" class="uppercase"></x-jet-input>
						</div>
						<div class="sm:col-span-3">
							<x-jet-input :disabled="!auth()->user()->can('customer_update')" wire:model.defer="fiscal_code" type="text" for="fiscal_code"
