				...
				<div>
					...
					<div class="mt-4 grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-6">
						<div class="sm:col-span-3">
							<x-jet-input :disabled="!auth()->user()->can('customer_update')" wire:model.defer="legal_representative_first_name" type="text"
							             for="legal_representative_first_name"
							             label="Nome"></x-jet-input>
						</div>
						<div class="sm:col-span-3">
							<x-jet-input :disabled="!auth()->user()->can('customer_update')" wire:model.defer="legal_representative_last_name" type="text"
							             for="legal_representative_last_name"
							             label="Cognome"></x-jet-input>
						</div>
						<div class="sm:col-span-6">
							<x-jet-input :disabled="!auth()->user()->can('customer_update')" wire:model.defer="legal_representative_fiscal_code" type="text"
							             for="legal_representative_fiscal_code"
							             label="Codice Fiscale" class="uppercase"></x-jet-input>
						</div>
						<div class="sm:col-span-2">
							<x-jet-input :disabled="!auth()->user()->can('customer_update')" wire:model.defer="legal_representative_street" type="text"
							             for="legal_representative_street"
							             label="Indirizzo"></x-jet-input>
						</div>
						<div class="sm:col-span-2">
							<x-jet-input :disabled="!auth()->user()->can('customer_update')" wire:model.defer="legal_representative_city" type="text"
							             for="legal_representative_city"
							             label="Città"></x-jet-input>
						</div>
						<div class="sm:col-span-2">
							<x-jet-input :disabled="!auth()->user()->can('customer_update')" wire:model.defer="legal_representative_province" type="text"
